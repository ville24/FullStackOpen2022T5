describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    it('Blogs are sorted by likes', function() {
      ...
      cy.get('#newblog').click()
      cy.get('[name=\'title\']').type('Go To Statement Considered Harmful')
      cy.get('[name=\'author\']').type('Edsger W. Dijkstra')
      cy.get('[name=\'url\']').type('http://www.u.arizona.edu/~rubinson/copyright_violations/Go_To_Considered_Harmful.html')
      cy.get('#createblog').click()
